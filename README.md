...
html << ".header { display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 30px; }"
...
html << ".overview { text-align: right; font-size: 14px; min-width: 160px; }"
html << "</style></head><body>"

html << "<div class='header'>"
html << "<h2 style='margin: 0;'>Test Coverage Progress Report</h2>"
